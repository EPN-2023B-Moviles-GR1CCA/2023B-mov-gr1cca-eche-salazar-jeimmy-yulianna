...
fun main() {
    ...
    val inmutable: String = "Jeimmy";
    // inmutable = "Yulianna";

    // Mutables (Re asignar)
    var mutable: String = "Yulianna";
    mutable = "Jeimmy"; //; opcional
    ...
    //  val > var siempre usamos val
    // Duck Typing, ya difine la variable
    var ejemploVariable = " Jeimmy Eche " //no hay que definir la variable, solo se le pone el valor
    val edadEjemplo: Int = 12
    ejemploVariable.trim()
    // ejemploVariable = edadEjemplo;

    // Variable primitiva
    val nombreProfesor: String = "Jeimmy Eche"
...
// void -> Unit, cuando no se devuelve nada, pero también se puede omitir Unit
fun imprimirNombre(nombre: String): Unit {
    // "Nombre: " + variable + " bienvenido";
    println("Nombre : ${nombre}") //template states poniendo signo $
}
fun calcularSueldo(
    sueldo: Double, // Requerido
    tasa: Double = 12.00, // Opcional (defecto)
    bonoEspecial: Double? = null, // Opcion null -> nullable /null point insection en java ya no por ?:puede ser null o double
): Double {
    // Int -> Int? (nullable)
