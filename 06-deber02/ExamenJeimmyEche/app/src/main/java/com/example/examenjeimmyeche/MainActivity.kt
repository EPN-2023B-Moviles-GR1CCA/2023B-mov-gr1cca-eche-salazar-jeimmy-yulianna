...
import com.example.examenjeimmyeche.databinding.ActivityMainBinding
import com.google.android.material.snackbar.Snackbar

class MainActivity : AppCompatActivity() {
    lateinit var binding: ActivityMainBinding
    lateinit var bdHelper: BDMemoria

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_artista)

        bdHelper=BDMemoria(this)
        binding.btnNuevoArtista.setOnClickListener{
            if (binding.)
        }
